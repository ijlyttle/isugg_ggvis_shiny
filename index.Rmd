...
This is a set of half-baked vignettes of stuff we learned this summer using `ggvis` and `shiny` to develop apps in support of an online course in introductory applied statistics.

Some of these things are already in the shiny and ggvis documentation, but that we managed not well enough.

It should not be necessary to point out that we are big fans of both packages, and that what we learned is part of the joy and frustation of working with software, especially as it is being developed.
...
* Need to put something together about strokeOpacity and Firefox.
